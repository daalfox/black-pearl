            ...
            Event::Injected(payload) => match payload {
                InjectedPayload::Gossip => {
                    for n in &self.neighborhood {
                        ...
                        // include a couple of known messages randomly to let receiver
                        // know that we got their older messages
                        // we cap the number of extra messages to 10% to avoid excessive overhead.
